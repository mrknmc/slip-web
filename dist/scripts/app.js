...
(function (global){
var Backbone="undefined"!=typeof window?window.Backbone:"undefined"!=typeof global?global.Backbone:null,moment="undefined"!=typeof window?window.moment:"undefined"!=typeof global?global.moment:null;module.exports=Backbone.Model.extend({defaults:{yAxis:{title:"Light Intensity"},xAxis:{type:"datetime",title:{text:"Date"}},plotOptions:{areaspline:{fillOpacity:.4,marker:{enabled:!1,symbol:"circle",radius:2,states:{hover:{enabled:!0}}},tooltip:{valueDecimals:2}}},filter:{start:moment().add(-7,"days"),end:moment()}},title:function(){return{text:this.get("_id")+": Solar Power"}},getData:function(){var e=this.get("filter");return _.chain(this.get("measurements")).map(function(e){return{x:moment(e.timestamp,"X"),y:e.lightIntensity}}).filter(function(t){return t.x>=e.start&&t.x<e.end.clone().add(1,"days")}).value()}});
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
