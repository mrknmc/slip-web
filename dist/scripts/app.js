...
(function (global){
var Backbone="undefined"!=typeof window?window.Backbone:"undefined"!=typeof global?global.Backbone:null,AppView=require("./views/appView");new AppView;
...
(function (global){
var Backbone="undefined"!=typeof window?window.Backbone:"undefined"!=typeof global?global.Backbone:null,Solar=require("../models/solar"),Wind=require("../models/wind"),Measurements=Backbone.Collection.extend({}),solar=new Measurements([],{model:Solar});solar.url="/api/solar",exports.solar=solar;var wind=new Measurements([],{model:Wind});wind.url="/api/wind",exports.wind=wind;
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
...
(function (global){
var Backbone="undefined"!=typeof window?window.Backbone:"undefined"!=typeof global?global.Backbone:null,Upload=require("../models/upload"),Uploads=Backbone.Collection.extend({model:Upload,url:"/api/measurements",comparator:function(e,o){return e.get("created")>o.get("created")?-1:e.get("created")<o.get("created")?1:0}});module.exports=new Uploads;
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
...
(function (global){
var Backbone="undefined"!=typeof window?window.Backbone:"undefined"!=typeof global?global.Backbone:null,moment="undefined"!=typeof window?window.moment:"undefined"!=typeof global?global.moment:null;module.exports=Backbone.Model.extend({defaults:function(){return{yAxis:{title:"Light Intensity"},xAxis:{type:"datetime",title:{text:"Date"}},plotOptions:{areaspline:{fillOpacity:.4,marker:{enabled:!1,symbol:"circle",radius:2,states:{hover:{enabled:!0}}},tooltip:{valueDecimals:2}}}}},initialize:function(){var e=this.get("measurements"),t=moment(e[e.length-1].timestamp,"X");this.set("filter",{end:t,start:moment(t).add(-7,"days")})},title:function(){return{text:this.get("_id")+": Solar Power"}},getData:function(){var e=this.get("filter");return _.chain(this.get("measurements")).map(function(e){return{x:moment(e.timestamp,"X"),y:e.lightIntensity}}).filter(function(t){return t.x>=e.start&&t.x<e.end.clone().add(1,"days")}).value()}});
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{}],"/Users/mark/slip-web/app/scripts/models/upload.js":[function(require,module,exports){
(function (global){
var Backbone="undefined"!=typeof window?window.Backbone:"undefined"!=typeof global?global.Backbone:null,moment="undefined"!=typeof window?window.moment:"undefined"!=typeof global?global.moment:null;module.exports=Backbone.Model.extend({idAttribute:"_id",niceCreated:function(){return moment(this.get("created")).format("llll")},toDisplay:function(){return _.extend(this.toJSON(),{created:this.niceCreated(),url:this.url()})}});
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
...
(function (global){
var Backbone="undefined"!=typeof window?window.Backbone:"undefined"!=typeof global?global.Backbone:null,moment="undefined"!=typeof window?window.moment:"undefined"!=typeof global?global.moment:null;module.exports=Backbone.Model.extend({defaults:function(){return{yAxis:{title:"Wind Speed"},xAxis:{type:"datetime",title:{text:"Date"}},plotOptions:{areaspline:{fillOpacity:.4,marker:{enabled:!1,symbol:"circle",radius:2,states:{hover:{enabled:!0}}},tooltip:{valueDecimals:2}}}}},initialize:function(){var e=this.get("measurements"),t=moment(e[e.length-1].timestamp,"X");this.set("filter",{end:t,start:moment(t).add(-7,"days")})},title:function(){return{text:this.get("_id")+": Wind Speed"}},getData:function(){var e=this.get("filter");return _.chain(this.get("measurements")).map(function(e){return{x:moment(e.timestamp,"X"),y:e.windSpeed}}).filter(function(t){return t.x>=e.start&&t.x<=e.end}).value()}});
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{}],"/Users/mark/slip-web/app/scripts/routers/router.js":[function(require,module,exports){
(function (global){
var Backbone="undefined"!=typeof window?window.Backbone:"undefined"!=typeof global?global.Backbone:null,AppRouter=Backbone.Router.extend({routes:{uploads:"uploads",solar:"solar",wind:"wind",map:"map"}});router=new AppRouter,router.on("route",function(){$(window).resize()}),Backbone.history.start({pushState:!0}),module.exports=router;
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{}],"/Users/mark/slip-web/app/scripts/views/appView.js":[function(require,module,exports){
(function (global){
var Backbone="undefined"!=typeof window?window.Backbone:"undefined"!=typeof global?global.Backbone:null,router=require("../routers/router"),measurements=require("../collections/measurements"),UploadsView=require("./uploadsView"),UsersView=require("./usersView"),ChartsView=require("./chartsView");module.exports=Backbone.View.extend({el:"body",events:{"click #menu ul li a":"changeTab"},initialize:function(){new UploadsView,new UsersView,new ChartsView({el:"#solar .charts",collection:measurements.solar}),new ChartsView({el:"#wind .charts",collection:measurements.wind})},changeTab:function(e){var r=$(e.currentTarget);router.navigate(r.data("url"),{trigger:!0})}});
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
...
(function (global){
var Backbone="undefined"!=typeof window?window.Backbone:"undefined"!=typeof global?global.Backbone:null,moment="undefined"!=typeof window?window.moment:"undefined"!=typeof global?global.moment:null,Pikaday=require("pikaday");module.exports=Backbone.View.extend({template:_.template($("#chart-template").html()),initialize:function(){this.listenTo(this.model,"filtered",this.rerender),this.listenTo(this.model,"change",this.rerender)},rerender:function(){var e=this.model;return this.$panelBody=this.$(".panel-body"),this.$panelBody.highcharts({chart:{type:"areaspline"},credit:{enabled:!1},title:e.title(),xAxis:e.get("xAxis"),yAxis:e.get("yAxis"),plotOptions:e.get("plotOptions"),series:[{name:e.get("_id"),data:e.getData()}]}),this.chart=this.$panelBody.highcharts(),this},render:function(){var e=this.model;this.$el.html(this.template(e.toJSON()));var t=e.get("filter");return new Pikaday({field:this.$(".datepicker.start")[0],maxDate:new Date,defaultDate:new Date(t.start),setDefaultDate:!0,onSelect:function(){t.start=this.getMoment(),e.set("filter",t),e.trigger("filtered")}}),new Pikaday({field:this.$(".datepicker.end")[0],maxDate:new Date,defaultDate:new Date(t.end),setDefaultDate:!0,onSelect:function(){t.end=this.getMoment(),e.set("filter",t),e.trigger("filtered")}}),this.rerender()}});
}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
...
},{"moment":"/Users/mark/slip-web/node_modules/pikaday/node_modules/moment/moment.js"}]},{},["./app/scripts/app.js"]);
